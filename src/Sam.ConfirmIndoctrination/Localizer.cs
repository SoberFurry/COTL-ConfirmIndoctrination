...
/// Language is taken from the game (I2.Loc) when possible, otherwise the OS UI culture.
/// </summary>
internal static class Localizer
{
    ...
    public static string Get(string key)
    {
        ...
        return key; // never expose nothing; key is more useful than empty
    }
    ...
    private static string DetectLanguage()
    {
        try
        {
            // Game language (I2 Localization) — covers in-game language switch.
        ...
        {
            // I2 may not be ready this early — fall through to culture.
        }
        try
        {
    ...
    private static Dictionary<string, string> Load(string lang)
    {
        ...
        try
        {
            ...
            if (s == null)
            {
                _log?.LogWarning($"Localization resource not found: {resName}");
                return result;
            }
